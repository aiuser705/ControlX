# CONTROL X — MASTER PROJECT KNOWLEDGE DOCUMENT
...
- **Physical Realism:** Glass elements simulate real optical physical properties:
  ...
  - Internal emerald absorption & volumetric attenuation (`attenuationColor = "#0F8259"`, `attenuationDistance = 0.5`).
...
- **Composition:** Centered vertical stack:
  ...
  2. Glass X 3D Emblem / Visual: Centered 3D emerald glass logo ($240\text{px} \times 240\text{px}$) with bevelled facets, specular highlights, ground reflection ellipse, and soft drop shadow (`filter: drop-shadow(0 24px 48px rgba(15, 130, 89, 0.22))`).
